...
#### `@omdp/dsh-archived-sessions` — archived-session manager (`v0.3.2`)
...
```jsonc
"dependencies": { "@omdp/dsh-archived-sessions": "^0.3.2" }
```
...
"dependencies": {
  ...
  "@omdp/dsh-archived-sessions": "^0.3.2"
}
```
...
#### `@omdp/dsh-archived-sessions` — 归档会话管理（`v0.3.2`）
